...
const SETTINGS = [
  ...
  },
  {
    ...
    choiceLabels: {
      auto: "Auto (follow active provider)",
      gemini: "Google Gemini",
      openai: "OpenAI-compatible (Whisper)",
    },
    group: "ai",
    label: "Speech-to-text provider",
    hint: "Which engine powers !stt audio transcription. 'Auto' follows your active chat provider.",
  },
  {
    ...
    group: "ai",
    label: "OpenAI-compatible Whisper model",
    hint: "Model used for speech transcription when OpenAI-compatible is selected for STT (whisper-large-v3, whisper-1).",
  },
  {
    key: "openai_api_key",
    type: "secret",
